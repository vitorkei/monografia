...
%Pode-se dizer que uma rede neural é um aproximador de uma função
Enquanto o tipo de entrada e saída da rede neural determinam o número de neurônios das respectivas camadas, a quantidade de nós nas camadas ocultas são arbitrários, normalmente definidos por meio de tentativa e erro.
...
Um modelo que tenha bom desempenho nos dois conjuntos não tem problemas de \textit{overfitting}.
