...
%Estudos em IA nas últimas décadas mostraram que computadores não apenas conseguem automatizar certas tarefas, executando-as com maior eficiência e velocidade que seres humanos, como também são capazes de aprender.
...
%, uma breve descrição sobre elas e o motivo de suas escolhas.
